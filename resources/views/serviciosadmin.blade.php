...
<head>
    ...
    <title>Agregar Servicios - Mr. Compulap</title>
    ...
    <main class="container mt-4">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombreServicio" placeholder="Ingresa el nombre del servicio" required>
            </div>
            <div class="form-group">
                <label for="precioServicio">Precio:</label>
                <input type="number" class="form-control" id="precioServicio" placeholder="Ingresa el precio del servicio" required>
            </div>
            <div class="form-group">
                <label for="descripcionServicio">Descripción:</label>
                <textarea class="form-control" id="descripcionServicio" rows="3" placeholder="Ingresa una descripción del servicio" required></textarea>
            </div>
